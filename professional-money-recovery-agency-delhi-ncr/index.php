    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
        ...
        <section id="hero-animation">
            <div id="landingHero" class="section-py landing-hero position-relative">
                <img src="../img/hero-bg.png" alt="hero background" class="position-absolute top-0 start-50 translate-middle-x object-fit-cover w-100 h-100" data-speed="1" />

                <div class="container">
                    <div class="hero-text-box text-center position-relative">
                        <h1 class="text-primary hero-title display-6 fw-extrabold">Your Financial Status Is Our Goal</h1>
                        <h2 class="hero-sub-title h6 mb-6">
                        Established with the mission to provide efficient collection services and<br class="d-none d-lg-block" />
                       ability to adapt to the ever-changing financial environment
                            
                        </h2>
                        <div class="landing-hero-btn d-inline-block position-relative">
                            <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">Join TBM <img src="../img/Join-community-arrow.png" alt="Join community arrow" class="scaleX-n1-rtl" /></span>
        ...
        <section id="landingFeatures" class="section-py landing-features">
            <div class="container">
                <div class="text-center mb-4">
                    <span class="badge bg-label-primary">Experience</span>
                </div>
                <h4 class="text-center mb-1">
                    <span class="position-relative fw-extrabold z-1">14 Years Of Experience

                    </span>
                    In Financial Support
                </h4>
                <p class="text-center mb-12">Debt Collections, Customer Supports, Grievance Handling, document follow up , digital application completion & Refer and Earn program promotion</p>
                <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        ...
                        <h5 class="mb-2">Debt Collections</h5>
                        <p class="features-icon-description">True Business Minds leverages cutting-edge technology to enhance debt collection. Our proprietary dialer improves communication, while real-time reporting offers immediate insights..</p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="mb-4 text-primary text-center">
                        ...
                        <h5 class="mb-2">Financial consultancy services</h5>
                        <p class="features-icon-description">At TBM, we offer a wide range of financial consultancy services designed to help businesses and individuals achieve their financial goals..</p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        ...
                        <h5 class="mb-2">TBM-CollectTech</h5>
                        <p class="features-icon-description">Explore our cutting-edge collection technology solutions , designed to streamline debt recovery processes and optimize your financial operations.</p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4 text-primary">
                            <svg width="64" height="65" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="features-icon-description">At True Business Minds, we prioritize seamless integration across all aspects of our debt collection services.</p>
                    </div>
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4 text-primary">
                            <svg width="64" height="65" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="features-icon-description">Well trained agents help our clients and customers.</p>
                    </div>
                    <!-- <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4 text-primary">
                            <svg width="64" height="65" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!--                <img src="../assets/img/section-title-icon.png" alt="laptop charging" class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />-->
        <!--            </span>-->
        <!--            by Real People-->
        <!--        </h4>-->
        ...
        <!--                        <img src="model-1.png" class="position-absolute card-img-position bottom-0 start-50" alt="human image" />-->
        <!--                    </div>-->
        ...
        <!--                        <img src="../assets/img/team-member-2.png" class="position-absolute card-img-position bottom-0 start-50" alt="human image" />-->
        <!--                    </div>-->
        ...
        <!--                        <img src="../assets/img/team-member-3.png" class="position-absolute card-img-position bottom-0 start-50" alt="human image" />-->
        <!--                    </div>-->
        ...
        <!--                        <img src="../assets/img/team-member-4.png" class="position-absolute card-img-position bottom-0 start-50" alt="human image" />-->
        <!--                    </div>-->
                ...
                <div class="row gy-12 align-items-center">
                    <div class="col-lg-5">
                        <div class="text-center">
                            <img src="../assets/img/faq-boy-with-logos.png" alt="faq boy with logos" class="faq-image" />
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="accordion" id="accordionExample">
                            <div class="card accordion-item active">
                                <h2 class="accordion-header" id="headingOne">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordionOne" aria-expanded="true" aria-controls="accordionOne">Who we are?</button>
                                </h2>

                                <div id="accordionOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">Our team consists of over 100 dedicated agents, including 40+ field agents, strategically positioned across various cities and pincodes. This extensive network allows us to connect with clients and debtors effectively, ensuring personalized service and maximizing recovery efforts.</div>
                                </div>
                            </div>
                            <div class="card accordion-item">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionTwo" aria-expanded="false" aria-controls="accordionTwo">What we do?</button>
                                </h2>
                                <div id="accordionTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">We manage collections using a comprehensive approach that combines digital campaigns with on-the-ground support. Our proprietary dialer technology empowers our agents to engage with debtors efficiently, providing real-time insights and performance tracking through our live dashboard. This innovative system allows us to respond quickly and effectively to your needs.</div>
                                </div>
                            </div>
                            <div class="card accordion-item ">
                                <h2 class="accordion-header" id="headingThree">
                                    <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordionThree" aria-expanded="false" aria-controls="accordionThree">Vision?</button>
                                </h2>
                                <div id="accordionThree" class="accordion-collapse collapse " aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        To be a leading force in the debt collection industry by leveraging technology and skilled personnel to deliver exceptional results for our clients.
                                    </div>
                                </div>
                            </div>
        ...
        <!-- <section id="landingCTA" class="section-py landing-cta position-relative p-lg-0 pb-0">
            <img src="../assets/img/cta-bg-light.png" class="position-absolute bottom-0 end-0 scaleX-n1-rtl h-100 w-100 z-n1" alt="cta image" data-app-light-img="front-pages/backgrounds/cta-bg-light.png" data-app-dark-img="front-pages/backgrounds/cta-bg-dark.png" />
            <div class="container">
                <div class="row align-items-center gy-12">
                    ...
                    <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
                        <img src="../assets/img/cta-dashboard.png" alt="cta dashboard" class="img-fluid mt-lg-4" />
                    </div>
                </div>
            </div>
        </section> -->
                ...
                <div class="row g-6">
                    <div class="col-lg-5">
                        <div class="contact-img-box position-relative border p-2 h-100">
                            <img src="../assets/img/contact-border.png" alt="contact border" class="contact-border-img position-absolute d-none d-lg-block scaleX-n1-rtl" />
                            <img src="../assets/img/contact-customer-service.png" alt="contact customer service" class="contact-img w-100 scaleX-n1-rtl" />
                            <div class="p-4 pb-2">
                                <div class="row g-4">
                                    <div class="col-md-6 col-lg-12 col-xl-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h6 class="mb-0"><a href="mailto:hr@truebusinessminds.com " class="text-heading">hr@truebusinessminds.com </a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-12 col-xl-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <h6 class="mb-0"><a href="tel:+919599118968" class="text-heading">+91 9599118968</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>B-415 & 233 , Pacific Business Park,Ghaziabad, 201010 Uttar Pradesh</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 9599118968</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>hr@truebusinessminds.com</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">TBM</a>, All Right Reserved.
                </div>
